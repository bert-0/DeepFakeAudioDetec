...
from .blocks import CNNEncoder, TemporalAttentionPool
...
class AttentionFusionNet(nn.Module):
    def __init__(self, n_classes: int = 2, dropout: float = 0.3):
        ...
        self.lfcc_attn = TemporalAttentionPool(self.lfcc_branch.out_channels)
        self.spec_attn = TemporalAttentionPool(self.spec_branch.out_channels)
